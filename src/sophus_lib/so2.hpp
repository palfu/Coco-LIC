...
public:
    ...
    //
    SOPHUS_FUNC explicit SO2(Transformation const& R) : unit_complex_(Scalar(0.5) * (R(0, 0) + R(1, 1)), Scalar(0.5) * (R(1, 0) - R(0, 1)))
    {
    ...
    //
    SOPHUS_FUNC static Sophus::Matrix<Scalar, DoF, num_parameters> Dx_exp_x(Tangent const& theta)
    {
        using std::cos;
        using std::sin;
    ...
    //
    SOPHUS_FUNC static Sophus::Matrix<Scalar, DoF, num_parameters> Dx_exp_x_at_0() { return Sophus::Matrix<Scalar, DoF, num_parameters>(Scalar(0), Scalar(1)); }
