...
inline PoseData XYThetaToPoseData(double x, double y, double theta, double timestamp = 0)
{
    PoseData pose;
...
inline void SE3dToPositionEuler(SE3d se3_pose, Eigen::Vector3d &position, Eigen::Vector3d &euler)
{
