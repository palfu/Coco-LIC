...
public:
    ...
    //
    bool ParsePointCloudNoFeature(PointCloudMsg::Ptr &lidar_msg, RTPointCloud::Ptr out_cloud);
...
private:
    ...
    //
    void OrganizedCloudToRangeImage(const RTPointCloud::Ptr cur_cloud, cv::Mat &dist_image, RTPointCloud::Ptr &corresponding_cloud) const;

    //
    void RTCloudToRangeImage(const RTPointCloud::Ptr cur_cloud, cv::Mat &dist_image, RTPointCloud::Ptr &corresponding_cloud) const;
