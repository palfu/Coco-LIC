...
public:
    ...
    static SO3 EvaluateRotation(const int64_t time_ns, const SplineSegmentMeta<N>& splne_meta, double const* const* knots, JacobianStruct* J = nullptr)
    {
   ...
   * @return  R(t)^T
   * */
    static SO3 EvaluateLogRT(const int64_t time_ns, const SplineSegmentMeta<N>& splne_meta, double const* const* knots, JacobianStruct* J = nullptr)
    {
        std::pair<double, size_t> ui = splne_meta.computeTIndexNs(time_ns);
        size_t s                     = ui.second;
        double u                     = ui.first;
    ...
    static Vec3 VelocityBody(const int64_t time_ns, const SplineSegmentMeta<N>& splne_meta, double const* const* knots, JacobianStruct* J = nullptr)
    {
        std::pair<double, size_t> ui = splne_meta.computeTIndexNs(time_ns);
        size_t s                     = ui.second;
        double u                     = ui.first;
    ...
    static Vec3 accelerationBody(const int64_t time_ns, const SplineSegmentMeta<N>& splne_meta, double const* const* knots)
    {
        std::pair<double, size_t> ui = splne_meta.computeTIndexNs(time_ns);
        size_t s                     = ui.second;
        double u                     = ui.first;
    ...
    static inline MatN blending_matrix_ = computeBlendingMatrix<SplineOrder, double,
